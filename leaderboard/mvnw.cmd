...
@SET __MVNW_PROJECT_DIR__=%~dp0
@IF "%__MVNW_PROJECT_DIR__:~-1%"=="\" SET __MVNW_PROJECT_DIR__=%__MVNW_PROJECT_DIR__:~0,-1%
@"%JAVA_HOME_CANDIDATE%\bin\java.exe" -jar "%__MVNW_WRAPPER_JAR__%" %* 2>nul
@IF ERRORLEVEL 1 @"%JAVA_HOME_CANDIDATE%\bin\java.exe" %JVMCONFIG% "-Dmaven.multiModuleProjectDirectory=%__MVNW_PROJECT_DIR__%" -classpath "%__MVNW_WRAPPER_JAR__%" org.apache.maven.wrapper.MavenWrapperMain %*
